class Game {
    ...
    generateTweet() {
        ...
        window.open("https://twitter.com/intent/tweet?url=https://here4u.co.uk;text=I scored "+ this.score +" points on Coloron! Can you beat my score?&amp;hashtags=coloron", "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
    }
